...
class Icon_SVG extends \Elementor\Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['svg_height'] = [
			'label'      => esc_html__( 'Height', 'sparch-core' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'px',
			],
		...
		$fields['icon_horizontal'] = [
			'label' => esc_html__( 'Horizontal', 'sparch-core' ),
			'type' => Controls_Manager::SLIDER,
		...
		$fields['icon_vertical'] = [
			'label' => esc_html__( 'Vertical', 'sparch-core' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => ['px', '%', 'em', 'rem'],
			'range' => [
				'px' => [
		...
		$fields['allow_box_shadow'] = [
			'label' => esc_html__( 'Icon Shadow', 'sparch-core' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => esc_html__( 'Icon Setting', 'sparch-core' ),
				'settings' => [
					'render_type' => 'ui',
