...
class Button_Hover extends \Elementor\Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [];
		$fields['text_color'] = [
			'label' => esc_html__( 'Text Color', 'sparch-core' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'title' => esc_html__( 'Text Color', 'sparch-core' ),
		...
		$fields['button_shadow'] = [
			'label'     => esc_html__( 'Button Shadow', 'sparch-core' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => esc_html__( 'Hover Setting', 'sparch-core' ),
				'settings' => [
					'render_type' => 'ui',
